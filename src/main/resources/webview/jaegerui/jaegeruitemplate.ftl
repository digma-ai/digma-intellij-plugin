...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-2ffe9fa5.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-23b691cb.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
