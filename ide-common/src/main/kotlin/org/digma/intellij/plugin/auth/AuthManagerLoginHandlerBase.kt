...
abstract class AuthManagerLoginHandlerBase(protected val analyticsProvider: RestAnalyticsProvider) : LoginHandler {

    override val logger: Logger = Logger.getInstance(this::class.java)

    protected val authManagerApiClient = AuthManagerApiClient(analyticsProvider)
    ...
    override fun login(user: String, password: String): LoginResult {
        ...
        return try {
            ...
            val loginResult = authManagerApiClient.login(user, password)
