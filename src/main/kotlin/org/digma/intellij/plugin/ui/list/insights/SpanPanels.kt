...
fun spanDurationPanel(spanDurationsInsight: SpanDurationsInsight, panelsLayoutHelper: PanelsLayoutHelper): JPanel {
    ...
    sortedPercentiles.forEach { percentile: SpanDurationsPercentile ->
        ...
        val pLabelText = "P${percentileName} ${percentile.currentDuration.value} ${percentile.currentDuration.unit}"
...
fun buildLinkToJaeger(traceSamples: List<TraceSample>, embedLinks: Boolean = false): String {
    val jaegerAddress = "http://localhost:16686/" //TODO: take from config
