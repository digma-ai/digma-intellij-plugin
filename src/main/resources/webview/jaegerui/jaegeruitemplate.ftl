...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-00dc084d.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-fa6a5c9b.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
