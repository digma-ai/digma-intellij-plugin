...
class AuthManagerCentralizedLoginHandlerBase(analyticsProvider: RestAnalyticsProvider) : AuthManagerLoginHandlerBase(analyticsProvider) {
            ...
            if (digmaAccount == null) {
                ...
                if (credentials == null) {
                    ...
                    if (!credentials.isAccessTokenValid()) {
                        ...
                        val result = authManagerApiClient.refreshToken(digmaAccount, credentials)
