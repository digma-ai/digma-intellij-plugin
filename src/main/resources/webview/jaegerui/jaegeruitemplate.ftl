...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-5daf6e5a.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-89b412fc.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
