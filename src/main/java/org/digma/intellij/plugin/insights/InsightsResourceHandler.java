...
public class InsightsResourceHandler implements CefResourceHandler {

    private final Logger logger = Logger.getInstance(InsightsResourceHandler.class);
    ...
    public InsightsResourceHandler(Project project, String path) {
    ...
    public boolean processRequest(CefRequest request, CefCallback callback) {
        ...
        if (InsightsService.getInstance(project).isIndexHtml(path)) {
            inputStream = InsightsService.getInstance(project).buildIndexFromTemplate(path);
        } else {
