...
public final class Icons {
    ...
    public static final Icon BACK_WHITE = colorizeVsCodeIcon("/icons/arrow-left.svg",Html.LIGHT_WHITE);
    public static final Icon BACK_BLACK = IconLoader.getIcon("/icons/arrow-left.svg", Icons.class.getClassLoader());
    public static final Icon FORWARD_WHITE = colorizeVsCodeIcon("/icons/arrow-right.svg",Html.LIGHT_WHITE);
