...
//            "idea.ProcessCanceledException" to "disabled"
            ...
            //"digma.otel.agent.override.path" to "/home/shalom/workspace/source-code/opentelemetry/opentelemetry-java-instrumentation/javaagent/build/libs/opentelemetry-javaagent-2.1.0.jar",
            //"digma.agent.override.path" to "/home/shalom/workspace/digma/digma-agent/build/libs/digma-agent-1.0.25.jar",
            //"digma.otel.extension.override.path" to "/home/shalom/workspace/digma/otel-java-instrumentation/agent-extension/build/libs/digma-otel-agent-extension-0.8.14.jar"
