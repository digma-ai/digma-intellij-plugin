...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-2d6ca1dc.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-polyfill" src="./static/polyfills-legacy-88394234.js"></script>
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-9486af1f.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
