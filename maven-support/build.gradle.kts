...
dependencies {
    ...
    intellijPlatform {
        ...
        //although this module can always build with IC because it's the same maven plugin, but just to be
        // sure to build with the maven plugin that ships with the current IDE.
