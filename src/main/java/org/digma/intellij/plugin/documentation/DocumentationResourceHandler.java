...
public class DocumentationResourceHandler implements CefResourceHandler {
    ...
    public DocumentationResourceHandler(Project project, String path, DocumentationVirtualFile file) {
    ...
    public boolean processRequest(CefRequest request, CefCallback callback) {
        ...
        if (DocumentationService.getInstance(project).isIndexHtml(path)) {
            inputStream = DocumentationService.getInstance(project).buildIndexFromTemplate(path, documentationVirtualFile);
        } else {
