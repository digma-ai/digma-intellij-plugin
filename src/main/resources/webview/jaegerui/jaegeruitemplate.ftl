...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-ea26f8cb.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-polyfill" src="./static/polyfills-legacy-d37cc335.js"></script>
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-ffbab132.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
