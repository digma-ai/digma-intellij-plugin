...
dependencies {
    ...
    implementation("org.jetbrains.intellij.platform:intellij-platform-gradle-plugin:2.5.0") // Update also org.jetbrains.intellij.platform.settings in settings.gradle.kts
