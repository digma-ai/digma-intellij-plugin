...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-94a7cd12.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-3124d49c.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
