...
@ConstructorProperties(
    ...
    //creationTime is added to this class, so it should be nullable for backwards compatibility
    ...
    //check if this credentials was created earlier than seconds ago
    @JsonIgnore
