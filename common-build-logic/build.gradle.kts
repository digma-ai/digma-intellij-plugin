...
dependencies {
    ...
    implementation("org.jetbrains.intellij.platform:intellij-platform-gradle-plugin:2.2.0") // Update also org.jetbrains.intellij.platform.settings in settings.gradle.kts
