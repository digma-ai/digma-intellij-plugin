...
object RunConfigurationHandlersHolder {
    ...
    //some RunConfigurationInstrumentationHandler s are delegating facades to services that provide the real work.
    ...
    val runConfigurationHandlers: List<RunConfigurationInstrumentationHandler>
