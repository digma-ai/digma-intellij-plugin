...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-c615ad4d.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-f3eca80b.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
