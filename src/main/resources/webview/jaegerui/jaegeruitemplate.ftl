...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-57c69155.js"></script>
    <link rel="stylesheet" href="./static/index-cf8076a0.css">
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-c8ed7401.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
