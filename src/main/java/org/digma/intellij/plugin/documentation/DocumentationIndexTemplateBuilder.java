...
class DocumentationIndexTemplateBuilder {
    ...
    public DocumentationIndexTemplateBuilder() {
        freemarketConfiguration.setClassForTemplateLoading(this.getClass(), DocumentationFileEditor.RESOURCE_FOLDER_NAME);
    ...
    public InputStream build(Project project, DocumentationVirtualFile documentationVirtualFile) {
