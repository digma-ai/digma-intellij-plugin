...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-321d1549.js"></script>
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-ef53a665.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
