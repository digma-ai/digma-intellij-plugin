...
<html lang="en">
  <head>
    ...
    <base href="/jaeger-ui/" data-inject-target="BASE_URL" />
    ...
    <script type="module" crossorigin src="./static/index-3c6ba5eb.js"></script>
        <link rel="stylesheet" href="./static/index-cd10bff0.css">
      ...
      <body>
        ...
        <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-51cad25c.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
      </body>
    </html>