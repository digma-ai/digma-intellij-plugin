...
//    @NotNull
//     static String getInstLibraryFromReceiverExpression(@NotNull PyExpression receiver) {
//
...
//
//    @NotNull
//     static String getInstLibraryFromReferenceExpression(@NotNull PyReferenceExpression referenceExpression) {
//
...
//    @NotNull
//     static String getInstLibraryFromAssignmentStatement(@NotNull PyAssignmentStatement assignmentStatement) {
...
//    @NotNull
//     static String getInstLibraryFromCallExpression(@NotNull PyCallExpression callExpression) {
...
//
//    @NotNull
//     static String getInstLibraryFromGetTracerArgument(@NotNull PyExpression arg) {
...
//
//    @NotNull
//     static String getInstLibraryFromArgumentReferenceExpression(@NotNull PyReferenceExpression referenceExpression) {
//
...
//
//    @NotNull
//     static String getSpanNameFromNameArgument(@NotNull PyExpression pyExpression) {
...
//
//    @NotNull
//     static String getSpanNameFromReferenceExpression(@NotNull PyReferenceExpression referenceExpression) {
//
//        if (Constants.PYTHON_MODULE_NAME_VARIABLE.equals(referenceExpression.getText())) {
//            return Constants.PYTHON_MODULE_NAME_VARIABLE;
//        }
...
//
//    @NotNull
//     static String getStringFromStringLiteralExpression(@NotNull PyStringLiteralExpression stringLiteralExpression) {
