...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="./static/index-0838f333.js"></script>
    <link rel="stylesheet" href="./static/index-116d7499.css">
  ...
  <body>
    ...
    <script nomodule crossorigin id="vite-legacy-entry" data-src="./static/index-legacy-2c12106b.js">System.import(document.getElementById('vite-legacy-entry').getAttribute('data-src'))</script>
  </body>
</html>
